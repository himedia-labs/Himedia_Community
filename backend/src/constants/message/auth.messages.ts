export const AUTH_ERROR_MESSAGES = {
  ...
  APPROVAL_REJECTED: '관리자 승인 거절된 계정입니다. 관리자에게 문의해주세요.',
...
export const AUTH_VALIDATION_MESSAGES = {
  ...
  PROFILE_HANDLE_STRING: '프로필 아이디는 문자열이어야 합니다.',
  PROFILE_HANDLE_MAX_LENGTH: '프로필 아이디는 50자 이하여야 합니다.',
  PROFILE_HANDLE_PATTERN: '프로필 아이디는 영문/숫자/._-만 사용할 수 있습니다.',
  PROFILE_HANDLE_REQUIRED: '프로필 아이디를 입력해주세요.',
