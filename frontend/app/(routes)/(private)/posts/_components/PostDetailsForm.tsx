...
} from '@/app/(routes)/(private)/posts/_handlers/postDetailsForm.handlers';

import styles from '@/app/(routes)/(private)/posts/_components/PostForm.module.css';
...
export default function PostDetailsForm({ category, tag }: PostDetailsFormProps) {
  ...
  useEffect(() => {
    ...
    const handleClickOutside = createHandleCategoryClickOutside(categoryRef, setIsCategoryOpen);
