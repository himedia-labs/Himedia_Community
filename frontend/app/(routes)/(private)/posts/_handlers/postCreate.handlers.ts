...
import { extractTags } from '@/app/(routes)/(private)/posts/_utils/extractTags.utils';
 ...
 */
export const createAddTagsFromInput = (params: AddTagsFromInputParams) => {
  return (value: string) => {
 ...
 */
export const createCommitTagInput = (params: CommitTagInputParams) => {
  return (value: string) => {
