...
import type { FormatProfileSocialLinksParams, ProfileSocialLink } from '@/app/shared/types/mypage';

/**
 * 프로필 소셜 링크 포맷
 * @description 소셜 링크 배열을 생성하고 href가 있는 항목만 필터링한다
 */
export const formatProfileSocialLinks = (params: FormatProfileSocialLinksParams): ProfileSocialLink[] => {
  return [
    {
