...
import MyPageAccountSettingsSection from '@/app/(routes)/(private)/mypage/_components/features/MyPageAccountSettingsSection';

import type { MyPageAccountTabProps } from '@/app/shared/types/mypage';

/**
 * 계정 설정 탭
 * @description 계정 설정 본문과 탈퇴 모달을 조합합니다.
 */
