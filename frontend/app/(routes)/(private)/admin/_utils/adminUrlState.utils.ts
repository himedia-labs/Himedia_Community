import {
  ADMIN_MENU_LABELS,
  ADMIN_PENDING_SORT,
  ADMIN_SORT_QUERY_VALUE,
  ADMIN_TAB_QUERY_VALUE,
...
export const parseAdminMenuFromQuery = (value: string | null): AdminMenuLabel => {
  if (value === ADMIN_TAB_QUERY_VALUE.PENDING_USERS) return ADMIN_MENU_LABELS.PENDING_USERS;
  ...
  if (value === ADMIN_TAB_QUERY_VALUE.NOTICE_ANNOUNCEMENTS) return ADMIN_MENU_LABELS.NOTICE_ANNOUNCEMENTS;
  if (value === ADMIN_TAB_QUERY_VALUE.NOTICE_UPDATES) return ADMIN_MENU_LABELS.NOTICE_UPDATES;
  if (value === ADMIN_TAB_QUERY_VALUE.NOTICE_POST_CREATE) return ADMIN_MENU_LABELS.NOTICE_POST_CREATE;
  if (value === ADMIN_TAB_QUERY_VALUE.NOTICE_UPDATE_CREATE) return ADMIN_MENU_LABELS.NOTICE_UPDATE_CREATE;
...
export const serializeAdminMenuToQuery = (menu: AdminMenuLabel) => {
  if (menu === ADMIN_MENU_LABELS.PENDING_USERS) return ADMIN_TAB_QUERY_VALUE.PENDING_USERS;
  ...
  if (menu === ADMIN_MENU_LABELS.NOTICE_ANNOUNCEMENTS) return ADMIN_TAB_QUERY_VALUE.NOTICE_ANNOUNCEMENTS;
  if (menu === ADMIN_MENU_LABELS.NOTICE_UPDATES) return ADMIN_TAB_QUERY_VALUE.NOTICE_UPDATES;
  if (menu === ADMIN_MENU_LABELS.NOTICE_POST_CREATE) return ADMIN_TAB_QUERY_VALUE.NOTICE_POST_CREATE;
  if (menu === ADMIN_MENU_LABELS.NOTICE_UPDATE_CREATE) return ADMIN_TAB_QUERY_VALUE.NOTICE_UPDATE_CREATE;
