...
} from '@/app/(routes)/(private)/admin/_utils/adminUrlState.utils';

import type {
  AdminMenuLabel,
  AdminPendingSort,
  AdminSelectMenuParams,
  AdminSelectSortParams,
  AdminSyncUrlStateParams,
 ...
 */
export const createSyncAdminUrlState = (params: AdminSyncUrlStateParams) => {
 ...
 */
export const createHandleSelectMenu = (params: AdminSelectMenuParams) => {
 ...
 */
export const createHandleSelectSort = (params: AdminSelectSortParams) => {
