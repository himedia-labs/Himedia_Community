...
import { usePostList, usePostListInfiniteScroll } from '@/app/(routes)/(public)/main/_components/postList/hooks';
import {
...
} from '@/app/(routes)/(public)/main/_components/postList/handlers';
