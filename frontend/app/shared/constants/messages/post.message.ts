...
export const POST_DETAIL_MESSAGES = {
  LIKE_COUNT_FAILURE: '좋아요 업데이트에 실패했습니다.',
...
export const TOAST_PUBLISH_FAILURE_MESSAGE = '게시물 게시에 실패했습니다.';
export const TOAST_PUBLISH_SUCCESS_MESSAGE = '게시물이 게시되었습니다.';
...
export const TOAST_UPDATE_FAILURE_MESSAGE = '게시물 수정에 실패했습니다.';
export const TOAST_UPDATE_SUCCESS_MESSAGE = '게시물이 수정되었습니다.';
