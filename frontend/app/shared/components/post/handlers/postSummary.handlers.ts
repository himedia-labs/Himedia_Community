 ...
 */
export const createHandlePostMenuButtonClick = (params: {
 ...
 */
export const createHandlePostEditButtonClick = (params: {
  stopLinkNavigation: (event: MouseEvent<HTMLElement>) => void;
 ...
 */
export const createHandlePostDeleteButtonClick = (params: {
  stopLinkNavigation: (event: MouseEvent<HTMLElement>) => void;
